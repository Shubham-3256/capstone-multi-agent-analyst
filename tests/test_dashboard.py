...
def test_home_page_execution(
    mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
    ...
    with (
        patch("app.services.history_service.HistoryService.workflows", return_value=[]),
...
def test_upload_page_execution(
    mock_uploader, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
def test_data_profile_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
@patch("streamlit.divider")
@patch("streamlit.info")
def test_feature_engineering_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
@patch("streamlit.divider")
@patch("streamlit.info")
def test_model_training_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
@patch("streamlit.divider")
@patch("streamlit.info")
def test_visualizations_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
@patch("streamlit.divider")
@patch("streamlit.info")
def test_business_insights_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
...
@patch("streamlit.divider")
@patch("streamlit.info")
def test_reports_page_empty_execution(
    mock_info, mock_div, mock_md, mock_title, mock_sidebar, mock_set_page_config
):
